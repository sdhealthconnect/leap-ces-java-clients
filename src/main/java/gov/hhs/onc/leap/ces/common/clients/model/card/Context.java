...
public class Context {
    ...
    public enum PurposeOfUse {
        ...
        HMARKT("HMARKT"), HOPERAT("HOPERAT"), HPAYMT("HPAYMT"), HRESCH("HRESCH"), PATRQT("PATRQT"), TREAT(
                "TREAT"), PUBHLTH("PUBHLTH");

        private final String value;
        private final static Map<String, Context.PurposeOfUse> CONSTANTS = new HashMap<String, Context.PurposeOfUse>();
    ...
    public enum Scope {
        ...
        ADR("adr"), RESEARCH("research"), PATIENT_PRIVACY("patient-privacy"), TREATMENT("treatment");

        private final String value;
        private final static Map<String, Context.Scope> CONSTANTS = new HashMap<String, Context.Scope>();
